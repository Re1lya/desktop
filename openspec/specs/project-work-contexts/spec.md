...
Define the persisted project work context contract that tracks which client window is actively working in which project, including lease-based recovery and occupancy enforcement.
